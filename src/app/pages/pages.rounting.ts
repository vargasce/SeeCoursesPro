...
const routes: Routes = [
  ...
  { path : 'registrarEntidad', loadChildren : () => import('./registrar-entidad/registrar-entidad.module').then( reference => reference.RegistrarEntidadModule), canActivate : [ CanActivateAdmin ]},
